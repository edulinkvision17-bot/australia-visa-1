...
export default function NationalIdentityDocument() {
    const columns = [
        {
            key: "document_type",
    ...
    const data = [
        {
            ...
            file_name: "National ID Proof.pdf",
            ...
            collapsedView={<>
                <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-1">
                        <p className="text-[13px] font-bold text-[#024d9e]">National Identity Document(other than Passport)</p>
                        <CircleQuestionMark size={14} className="bg-[#024d9e] text-[#fff] rounded-full"/>
                    </div>
                    <p className="text-gray-900 text-[14px] font-medium"><span className="font-extrabold text-[15px]">1</span> Recieved</p>
                </div>
            </>}
            expandedView={<>
                <div>
